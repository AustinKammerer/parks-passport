...
export default function JournalListItem({ entry }) {
  ...
  // format the timestamp generated by the database at log entry creation
  const dateTime = DateTime.fromISO(entry.time).toLocaleString(
  ...
  return (
    ...
    >
      <Grid container justifyContent="space-between">
        ...
        <Grid item xs={12} pt={1} pl={1}>
          <Typography>{entry.text}</Typography>
        </Grid>
        <Grid item xs={9} alignSelf="end">
          <Typography fontStyle="italic" variant="body2" color="gray">
            {dateTime}
          </Typography>
        </Grid>
        <Grid item xs={3}>
